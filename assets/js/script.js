...
// Dirubah 
const pengirim = "jaskia otplk007";
const nomorWa = "6288290612690" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `kenalin nama gue jaskia gue anak jaksel awokawok , ya gua mengakui bahwa di kelas kita yang paling ganteng tampan menawan jagoan gagah adalah maulidan riansyah alias jefri nichol`;
